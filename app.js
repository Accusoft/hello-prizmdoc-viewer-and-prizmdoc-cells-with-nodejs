...
// Setup the proxy to PrizmDoc Application Services (PAS). The viewer will send
// all of its requests for document content to the /pas-proxy route and the
// proxy will forward those requests on to PAS. If you are using PrizmDoc Cloud,
// the proxy will also inject your API key before forwarding the request.
